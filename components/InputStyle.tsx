...
const InputStyle = ({labelTxt, placeholder, register, registerName}: {labelTxt: string, placeholder: string, register: UseFormRegister<BookData>, registerName:  keyof BookData})=>{
    ...
    <div className="flex flex-col mt-6">
      ...
      <input className=" bg-[#E4B781] placeholder-[#311C0D] placeholder-opacity-50 w-80 h-8 text-center rounded-md" type="text" id={labelTxt}  placeholder={placeholder} {...register(registerName)}/>
      </div>
    </>)
}
